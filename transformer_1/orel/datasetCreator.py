...
def create_dataset(fromSong: int, toSong:int, existing_dataset_path: str, log_file_path: str, songsDataPath = 'resources/HeSongsWords.csv', desired_token_num:int = -1):
    ...
    if desired_token_num == -1:
        ...
        create_one_token_dataset(fromSong, toSong, df, existing_dataset_path, log_file_path, data_dict)
...
create_dataset(49,141,"resources/big_general_dataset.pt","resources/logs/used_songs_general_dataset.log")