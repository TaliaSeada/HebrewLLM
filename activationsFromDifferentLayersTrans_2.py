...
layers_to_use = [1]
list_of_datasets = ["generated", "cities", "inventions", "elements", "animals", "facts", "companies"]
...
for dataset_to_use in list_of_datasets:
    ...
    for layer in layers_to_use:
        dfs[layer].to_csv("output_trans\\" + "translate_with_labels_" + dataset_to_use + "_" + str(abs(layer)) + "_rmv_period.csv", index=False)